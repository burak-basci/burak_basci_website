...
class AnimatedLineThroughText extends StatefulWidget {
  const AnimatedLineThroughText({
    ...
    this.slideBoxColor = Colors.black,
  ...
  @override
  AnimatedLineThroughTextState createState() => AnimatedLineThroughTextState();
}

class AnimatedLineThroughTextState extends State<AnimatedLineThroughText>
