...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _handleFirestoreOperation({
    ...
    // Error: Invalid login: 535-5.7.8 Username and Password not accepted. Learn more at535 5.7.8  https://support.google.com/mail/?p=BadCredentials l15-20020a5d674f000000b00317909f9985sm355124wrw.113 - gsmtp
    ...
    if (kDebugMode) {
      print('Snackbar dialog: $operationName was successful $successMessage');
    }
  }
    ...
    await _handleFirestoreOperation(
      ...
      projectOperation: () async {
        await FirebaseFirestore.instance.collection('mail').doc().set({
          ...
          'message': {
            'html': "",
            'subject': "from John with this email: john@gmail.com}, "
                "hey burak",
            'text': "hey burak",
          },
        });
